...
## set path
export HOMESW=/project/k1488/kadek/myLibs/GCC<br/>
...
cd hdf5-1.8.21<br/>
CPPFLAGS="-fPIC ${CPPFLAGS}" CC=mpigcc CXX=mpigxx FC=mpifc ./configure --enable-parallel --prefix=$HOMESW --with-zlib --disable-shared --enable-fortran<br/>
make -j8<br/>
make install<br/>
cd ..<br/>
...
CC=mpigcc CXX=mpigxx FC=mpifc CMAKE_PREFIX_PATH=$HOMESW:$CMAKE_PREFIX_PATH PKG_CONFIG_PATH=$HOMESW/lib/pkgconfig/:$PKG_CONFIG_PATH $HOMESW/bin/cmake/bin/cmake -DNETCDF=ON -DMETIS=ON -DPLASTICITY=OFF -DCOMMTHREAD=OFF -DASAGI=ON -DHDF5=ON -DCMAKE_BUILD_TYPE=Release -DTESTING=OFF  -DLOG_LEVEL=warning -DLOG_LEVEL_MASTER=info -DHOST_ARCH=hsw -DPRECISION=double ..<br/>
